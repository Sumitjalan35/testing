      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Entry-level role involving coding, testing, and learning new
            technologies under mentorship.
          </p>
        </div>
...
const Dashboard = () => {
  ...
  const { userProfile, aiAdvice, userType, jobMatches, updateJobMatches } =
    useCareer()
    ...
    const fetchMatches = async () => {
      ...
      try {
        ...
        const summary = [skills, soft, interests, userProfile?.additional_info]
          ...
          .join(', ')
        if (!summary) return
        const res = await apiService.getJobRecommendations({
          text: summary,
          topN: 5,
        })
        if (res?.success) {
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-primary-100 text-lg">
          Here's your personalized career dashboard with AI-powered insights and
          recommendations.
        </p>
        {!aiAdvice && (
          <div className="mt-4 p-4 bg-primary-500 rounded-lg">
            <p className="text-primary-100">
              Complete your profile setup to get personalized AI-powered career
              advice!
            </p>
            <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          >
            <div
              className={`w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-3 ${stat.color}`}
            >
      ...
      >
        ...
        {!jobMatches || jobMatches.length === 0 ? (
          <div className="text-secondary-600">
            No matches yet. Provide skills in your profile or use the Job
            Matcher to generate recommendations.
            <button
              onClick={() => navigate('/job-matcher')}
            ...
            {jobMatches.map((job, index) => (
              ...
              >
                ...
                <p className="text-secondary-600 mb-1">
                  Matched from your skills and interests.
                </p>
              </motion.div>
            ))}
          </div>
                  ...
                  <div className="flex items-center justify-end mb-3">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-5 h-5 ${
                          i < Math.floor(((job.match_score || 0) * 100) / 20)
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          },
          {
            ...
            description:
              'Practice with personalized interview questions based on your target role',
            icon: MessageCircle,
          ...
          },
          {
            ...
            description:
              'Take comprehensive skill assessments to identify strengths and gaps',
            icon: Award,
            color: 'bg-orange-100 text-orange-600',
            action: () => setActiveSection('skill-gap-analysis'), // <-- THIS IS THE CHANGE
          },
          {
            title: 'Career Chat',
            description:
              'Chat with our AI career counselor for personalized advice and guidance',
            icon: Brain,
          ...
          },
          {
            ...
            description:
              'Get tips and templates for professional networking and LinkedIn optimization',
            icon: Users,
